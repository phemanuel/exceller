...
class DashboardController extends Controller
{
    ...
    public function indexAdminView()
    {
        ...
        return view('layout.e-learning', compact('students', 'users', 'departments', 'questions',
    'softwareVersion', 'collegeSetup'));
    }
    ...
    'examSetting', 'students','departments','cbtAttempt', 'cbtCompleted'));
    }
    ...
    public function studentCbt($id)
    {
        try {   
            ...
            switch ($loginStatus) {
                case 1:
                    // return redirect()->back()->with('error', 'You are already logged in, contact the administrator to reset you exam.');
                ...
                case 2:
                    return redirect()->back()->with('error', 'You have completed the exam.');
