  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="infoModalLabel">Welcome to Exceller Global Institute</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body text-center">
        <!-- Image inside the modal -->
        <img src="{{ asset('images/landing-page.jpg') }}" width="319" height="452" alt="Exceller Global Institute" class="img-fluid rounded mb-3">
        
        <!-- <p>📢 <strong>Exciting Updates!</strong></p>  
        <p>Our <strong>Skill Acquisition Program</strong> is now open for enrollment. Join us to gain hands-on skills and secure your future.</p>   -->
      </div>
