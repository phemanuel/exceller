  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Course Material</li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          @elseif(session('error'))
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{route('material-update', ['id' => $material->id])}}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')              
              <div class="box-body">   
              ...
              <!-- Academic Session -->
                <div class="form-group">
                    ...
                    <select name="session1" class="form-control">
                        @foreach($acad_sessions as $rd)
                            <option value="{{ $rd->session1 }}" {{ $rd->session1 == $material->acad_session ? 'selected' : '' }}>
                                {{ $rd->session1 }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select name="programme" class="form-control">
                        @foreach($dept as $rd)
                            <option value="{{ $rd->department }}" {{ $rd->department == $material->programme ? 'selected' : '' }}>
                                {{ $rd->department }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select name="level" class="form-control">
                        @foreach($level as $rd)
                            <option value="{{ $rd->level }}" {{ $rd->level == $material->level ? 'selected' : '' }}>
                                {{ $rd->level }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select name="semester" class="form-control">
                        @foreach(['First', 'Second'] as $semester)
                            <option value="{{ $semester }}" {{ $semester == $material->semester ? 'selected' : '' }}>
                                {{ $semester }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select name="materialType" class="form-control">
                        @foreach(['Video', 'Text'] as $type)
                            <option value="{{ $type }}" {{ $type == $material->type ? 'selected' : '' }}>
                                {{ $type }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                 ...
                 <input type="text" name="materialTitle" class="form-control" value="{{$material->title}}">
                </div> 
                @error('materialTitle')
                    <span class="invalid-feedback">{{ $message }}</span>
                @enderror 
                ...
                <div class="form-group">
                  ...
                  <textarea id="editor1" name="contentData" rows="10" cols="80">                                           
                    {{$material->content_data}}</textarea>
                </div> 
                @error('contentData')
                    <span class="invalid-feedback">{{ $message }}</span>
                @enderror 
