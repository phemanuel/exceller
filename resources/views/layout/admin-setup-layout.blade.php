      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="box box-success direct-chat direct-chat-success">
            <div class="box-header with-border">
              <h3 class="box-title"><strong>Upload Course Materials</strong></h3>
            ...
            <div class="direct-chat-msg right">            
            <div class="direct-chat-text">
                    This module helps you to setup/Upload the following: <br>
                    - Course Materials in video and text format.                    
                  </div>
  </div>
            </div>
            <!-- /.box-body -->
