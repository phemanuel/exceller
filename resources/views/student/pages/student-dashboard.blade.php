        ...
        <ul class="nav navbar-nav"> 
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{asset('/uploads/' . 'blank.jpg')}}" class="user-image" alt="User Image">
              <span class="hidden-xs">{{$studentData->first_name}}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="{{asset('public/uploads/' . $studentData->picture_name . '.jpg')}}" class="img-circle" alt="User Image">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="{{asset('uploads/' . 'blank.jpg')}}" class="img-circle" alt="User Image">
        </div>
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box admin-box">
            ...
            <a href="{{route('student-course-material', ['id' => $studentData->id])}}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box students-box">
            ...
            <a href="{{route('student-report', ['id' => $studentData->id])}}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
