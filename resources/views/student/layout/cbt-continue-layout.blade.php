      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header">
            <h3 class="page-title">
              E-Learning - Check all information carefully before you proceed.
            </h3>
                  ...
                  <ul class="d-flex flex-column-reverse todo-list">
                    ...
                    <li>
                      <tr>
                              ...
                              <td><p class="bold-font">You have not completed the test, <strong>Click Continue E-Learning</strong>.</p></td>
                          </label>
												</div>	
                        </tr>											
											</li> 
                    ...
                    <form action="" method="post">
                      ...
                      <div class="form-check">
													<label class="form-check-label">
                          <a href="{{route('cbt-page', ['id' => $studentData->id])}}" class="btn btn-success btn-block">Continue E-Learning</a>                            
													</label>
												</div> 
                    </form>                   
