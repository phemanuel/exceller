  ...
  <tr>
           ...
           <table class="table">                       
                      <tr>
                              ...
                              <td><h2>You have successfully completed the test, <strong>Exit the E-Learning</strong>.</h2></td>
                          </label>
												</div>	
                        </tr>        
                    </table>
...
<table width="100%">
  <tr>
    ...
    <td><p><form action="" method="post">
                      ...
                      <div class="form-check">
													<label class="form-check-label">
                          <a href="{{route('student-logout')}}" class="btn btn-success btn-block">Exit E-Learning</a>                            
													</label>
												</div> 
                    </form></p></td>
    <td></td>
