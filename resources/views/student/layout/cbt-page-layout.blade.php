      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header">
            ...
            <table class="table">
                <tr>
                    <td> <h3 class="page-title">E-Learning - Read questions carefully and select the answer appropriately.</h3></td>
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel-2">Submit E-Learning</h5>
