...
Route::get('/', function () {
    ...
    Route::middleware('auth')->group(function () {    
        ...
        //Admin Dashboard----
        Route::get('admin-view', [DashboardController::class, 'indexAdminView'])
        ->name('admin-view');  
        ...
        // E-learning routes
            ...
            */
            ...
            |--------------------------------------------------------------------------
            */
            Route::post('/modules/{module}/materials', [CourseMaterialController::class, 'store'])
                ->name('materials.store');

            Route::get('/materials/{material}/edit', [CourseMaterialController::class, 'edit'])
                ->name('materials.edit');
